...
const Games = () => {
            ...
            renderCell: ({row: {banner} }) =>{
                return (
                    <Box
                        ...
                        overflow="hidden"
                    >
                        <img src={`https://echrily.shop/${banner}`} alt="banner" 
    ...
    return (
        <Box m="20px">
            ...
            <Box 
                ...
                sx={{
                    ...
                    "& .MuiDataGrid-virtualScroller" : {
                        backgroundColor:theme.palette.mode === "dark" ? colors.primary[700] : colors.grey[900]
                    },
            ...
            >
                <DataGrid rows={games} columns={columns} rowHeight={130}/>
            </Box>
        </Box>
    );
};
